    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Player player = new Player { UserName = Input.UserName, Email = Input.Email, Exp = 0, Lvl = 1, Money = 1000, ImageURL = new Random().Next(1, 15).ToString(), CurrentLand = randomLand, ResidenceLand = randomLand, RecruitAmount = 100 };
